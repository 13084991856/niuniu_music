    ...
    <layout>
      <div>
        ...
        <div>
          <div
            class="btn"
            :class="{ btnActive: languageflag == index }"
            @click="languageStyle(index, item)"
            :key="index"
        ...
        <div>
          <div
            class="btn"
            :class="{ btnActive: typeflag == index }"
            @click="typeStyle(index, item)"
            :key="index"
        ...
        <div>
          <div
            class="btn"
            :class="{ btnActive: alphabetflag == index }"
            @click="alphabetStyle(index, item)"
            :key="index"
