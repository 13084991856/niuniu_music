            ...
            <div class="left-top">
              ...
              <div>
                <el-button size="mini" round
                  ><i class="My-new-iconbianji"></i> 发动态</el-button
                >
                <el-button size="mini" round
                  ><i class="My-new-iconpaishe"></i> 发表视频</el-button
                >
              </div>
            </div>
            <!-- left-main -->
                ...
                <div class="content">
                  <div class="message">
                    <span class="content-tit"
                      >{{ item.user.nickname
                      }}<i class="My-new-iconyinle IconText"></i
                    ></span>
                    <span class="content-act">{{ item | getTitle }}</span>
                    <div class="time">
                      {{ item.showTime | filtrationTime(that) }}
                    </div>
                  </div>
                  <div class="comment">
                    <!-- {{item.json}} -->
                  ...
                  <div class="Song">
                    <div>
                      <img
                        style="width: 50px"
                        :src="JSON.parse(item.json) | GetSongPic"
                        alt=""
                      />
                    </div>
                    <div>
                      ...
                      <div class="singer">
                        {{ JSON.parse(item.json) | GetSingerName }}
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="bottom">
                    <span
                      ><i class="My-new-icondianzan"></i
                      ><span>(571)</span></span
                    >
                    <span>|</span>
                    <span
                      ><i class="My-new-iconfenxiang1"></i
                      ><span>转发 (6)</span></span
                    >
                    <span>|</span>
                    <span
                      ><i class="My-new-iconxiaoxi"></i
                      ><span>评论 (8)</span></span
                    >
                  </div>
                </div>
