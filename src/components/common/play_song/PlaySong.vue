    ...
    <ul v-if="SongData">
      ...
      <div class="Songli">
        <li
          ...
          @click="playMusic(item.song.id)"
          @mouseover="ChangeIsShow(index)"
        >
          <div>
            <!-- <span class="My-new-iconyinle" v-show="currentShow == index" ></span> -->
            <span>
              <i
                class="My-new-iconyinle icnColor"
                v-show="currentShow == index"
              ></i>
          ...
          <div>
            <span>{{ item.song.dt | GetTime() }}</span>
          </div>
        </li>
      </div>
    </ul>
    ...
    <ul v-if="SearchSongData">
      ...
      <div class="Songli">
        <li
          slot="songli"
          :key="index"
          v-for="(item, index) in SearchSongData"
